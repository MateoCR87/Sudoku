...
public class EsPistaCeldaValidarRegla implements Regla<CeldaDominio> {

	private static final Regla<CeldaDominio> INSTANCIA = new EsPistaCeldaValidarRegla();

	private EsPistaCeldaValidarRegla() {
		super();
	}
	...
	public void validar(CeldaDominio dato) {
		if (UtilObjeto.esNulo(dato.isEsPista())) {
			throw new SudokuDominioExepcion("La pista de una celda no puede ser nula.");
		}
	}
